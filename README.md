...
Modul 4 Refleksi\
1. Menurut saya alur TDD pada tutorial ini cukup membantu karena memaksa saya memulai kita memulai dari method atau perilaku yang diharapkan dahulu sebelum implementasinya. Saat mengerjakan fitur Payment dan Order, saya lebih mudah memecah kebutuhan menjadi unit kecil seperti model, repository, service, validasi voucher, dan validasi bank transfer. Dengan cara ini saya bisa langsung melihat apakah implementasi yang saya buat benar-benar memenuhi requirement atau belum.

2. Secara umum unit test yang saya buat sudah cukup mendekati prinsip F.I.R.S.T., tetapi masih ada beberapa hal yang perlu diperbaiki. Dari sisi Fast, test unit yang saya buat relatif cepat karena menggunakan mocking pada repository dan fokus pada logic service. Dari sisi Independent, sebagian besar test juga sudah berdiri sendiri karena setiap test menyiapkan data sendiri melalui setUp. Dari sisi Repeatable, hasil test seharusnya konsisten karena tidak bergantung pada environment eksternal. Dari sisi Self-Validating, test sudah memiliki assertion yang jelas untuk menentukan lulus atau gagal. Dari sisi Timely, saya sudah mencoba menulis test lebih awal, tetapi pada praktiknya belum selalu dilakukan sebelum implementasi untuk setiap detail kecil. Jadi, saya rasa prinsip F.I.R.S.T. sudah cukup terpenuhi.
