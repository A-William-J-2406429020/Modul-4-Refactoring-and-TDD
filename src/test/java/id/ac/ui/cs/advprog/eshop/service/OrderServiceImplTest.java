...
class OrderServiceTest {
    ...
    // Create a happy path test: Use createOrder to add a new Order.
    @Test
    ...
    // Create unhappy path test: invalid status
    @Test
    ...
    // Create unhappy path test: ID never used
    @Test
    ...
    // Happy path: find orders by author
    @Test
